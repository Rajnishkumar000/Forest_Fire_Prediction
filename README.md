...
FIRST RUN rename.py
then run api and backend which is inside a single file trainMINE6.py
then run app2.py //THIS works offline too
or 
if you want shorter frontend code then you can go for app1.py //THIS works